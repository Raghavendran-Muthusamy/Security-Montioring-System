...
select * from violation_history where EMP_ID in ((select emp_id from employee where group_id = ( select group_id FROM employee where USERNAME = (?))))
...
<title>View_Search Subordinates</title>
</head>
<body>
